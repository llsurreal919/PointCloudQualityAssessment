...
pc_ori=pcread("pc_sample\longdress_vox10_1300.ply");
pc_ori_normal=Normal_ES(pc_ori);
%% resampling point cloud 
pc_fast=pcread("pc_sample\longdress_vox10_130010000_4.ply");
%% Relevant parameters
...
for i=1:1:5
    pc_dis=pcread(strcat('pc_sample\longdress_gpccOT_',num2str(i),'.ply'));
    %% Normal estimate
